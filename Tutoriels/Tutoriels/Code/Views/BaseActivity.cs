namespace Tutoriels.Code
{
    public abstract class BaseActivity : Activity
    {
        ...
        /// <summary>
        /// Valeur des références des codes retours des écrans
        /// </summary>
        public static class RequestCode
        {
            public const int PickImage = 1000;

            public const int WebView = 1001;

            public const int BluetoothScanModeChanged = 1002;

            public const int Voice = 1003;

            public const int Permissions = 1004;
        }
