...
namespace Tutoriels.Code.Activities.Bluetooth
{
    ...
    internal class BluetoothService
    {
        ...
        /// </summary>
        /// <param name='secureKey'>A Handler to send messages back to the UI Activity.</param>
        /// <param name='insecureKey'>A Handler to send messages back to the UI Activity.</param>
